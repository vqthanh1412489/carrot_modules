      ...
      final header = Column(children: <Widget>[
        Material(
            ...
            borderRadius: BorderRadius.only(
                ...
                bottomLeft: (_queryTextController!.text.isEmpty || _response == null || _response!.predictions.isEmpty)
                    ? headerTopRightBorderRadius
                    : const Radius.circular(0),
                bottomRight: (_queryTextController!.text.isEmpty || _response == null || _response!.predictions.isEmpty)
                    ? headerTopRightBorderRadius
                    : const Radius.circular(0)),
            child: Row(
