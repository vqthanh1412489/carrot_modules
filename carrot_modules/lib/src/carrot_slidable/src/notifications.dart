...
class SlidableGroupNotificationDispatcher<T> {
  ...
  void dispatch(T notification) {
    ...
    final effectiveNotification = onNotification != null ? onNotification(notification) : notification;
...
class SlidableGroupBehavior<T> extends StatefulWidget {
  ...
  @override
  _SlidableGroupBehaviorState<T> createState() => _SlidableGroupBehaviorState<T>();
}
...
class _InheritedSlidableNotification<T> extends InheritedWidget {
  ...
  static ValueNotifier<T?>? of<T>(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<_InheritedSlidableNotification<T>>()?.notifier;
  }
...
class SlidableGroupBehaviorListener<T> extends StatefulWidget {
  ...
  @override
  State<SlidableGroupBehaviorListener<T>> createState() => _SlidableGroupBehaviorListenerState<T>();
}

class _SlidableGroupBehaviorListenerState<T> extends State<SlidableGroupBehaviorListener<T>> {
