...
class _SlidableDismissalState extends State<SlidableDismissal> with SingleTickerProviderStateMixin {
  bool resized = false;
  ...
  void didUpdateWidget(covariant SlidableDismissal oldWidget) {
    ...
    if (oldWidget.controller != widget.controller) {
      oldWidget.controller.resizeRequest.removeListener(handleResizeRequestChanged);
      widget.controller.resizeRequest.addListener(handleResizeRequestChanged);
    }
  }
